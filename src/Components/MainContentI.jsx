...
const MainContentI = ({ buttonType, onItemClick, searchQuery = '' }) => {
  const [items, setItems] = useState([
    { id: 1, name: 'Exchange Stock', Numbers: '256 Cylinders', selected: false },
    { id: 2, name: 'Lend Stock', Numbers: '527 Cylinders', selected: false },
    { id: 3, name: 'Rent Stock ', Numbers: '226 Cylinders', selected: false },
    { id: 4, name: 'Properties', Numbers: '567 Cylinders', selected: false },
